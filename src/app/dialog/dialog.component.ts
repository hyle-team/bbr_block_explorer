import {HostListener, Component, Input, Output, EventEmitter, Renderer2, OnChanges, ElementRef} from '@angular/core';
...
export class DialogComponent implements OnChanges {
    ...
    hashchangeFunc(event) {
        if (event.type === 'hashchange') {
            window.location.hash === '#modalOpen' ? this.visible = true : this.visible = false;
        }
    }
